            ...
            <aside class="bg-green-700/40 bg-[radial-gradient(circle,rgba(255,255,255,0.2)_1px,transparent_1px)] bg-size-[6px_6px] backdrop-blur-md p-2 rounded-2xl shadow-xl/30 ring-2 ring-inset ring-white/50 inset-shadow-sm inset-shadow-white/90">
              <div class="flex lg:gap-142 justify-between items-center">
                ...
                <div class="flex flex-wrap items-center gap-0.5 justify-center">
                  ...
                  <Link to="/arts" class="p-1.5 bg-green-800 rounded-xl shadow-xl/15 font-comicsans inset-shadow-sm inset-shadow-white/80 transition hover:scale-115 hover:shadow-xl/50 hover:bg-red-800/60 text-white">Arts</Link>
