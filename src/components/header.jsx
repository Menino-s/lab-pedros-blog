...
export default function Headr() {
    ...
    <div class="">
      <div class="grid pb-2 justify-items-center">
        <div class="bg-white/1 rounded-b-2xl backdrop-blur-md backdrop-brightness-105 shadow-xl/50 drop-shadow-2xl drop-shadow-green-700 ring-2 ring-inset ring-white/50 inset-shadow-sm inset-shadow-white/90 grid justify-center content-center">
            ...
            <aside class="bg-green-800/40 bg-[radial-gradient(circle,rgba(255,255,255,0.2)_1px,transparent_1px)] bg-size-[6px_6px] backdrop-blur-md p-2 rounded-2xl shadow-xl/30 ring-2 ring-inset ring-white/50 inset-shadow-sm inset-shadow-white/90">
              <div class="flex lg:gap-142 justify-between items-center">
                ...
                <div class="flex flex-wrap items-center gap-0.5 justify-center">
                  ...
                  <Link to="/blog" class="relative p-1.5 bg-green-950/70 rounded-xl shadow-xl/15 font-comicsans inset-shadow-sm inset-shadow-white/80 transition hover:scale-115 hover:shadow-xl/50 hover:shadow-white/50 hover:bg-green-800 text-white">Blog <span className="absolute top-1 right-0.5 flex h-2 w-2"> <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-red-400 opacity-75"></span> <span className="relative inline-flex rounded-full h-1.5 w-1.5 bg-red-500"></span> </span></Link>
