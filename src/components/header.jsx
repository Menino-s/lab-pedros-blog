...
export default function Headr() {
    ...
    <div class="">
            ...
            <aside class="bg-green-700 p-2 rounded-2xl shadow-xl/30 inset-shadow-sm inset-shadow-green-900">
              <div class="flex gap-3 justify-between items-center">
                ...
                <div class="flex flex-wrap items-center gap-1 dark:text-white justify-center">
                  <Link to="/" class="p-1.5 bg-green-600 rounded-2xl shadow-xl/15 font-comicsans inset-shadow-sm inset-shadow-white/80 transition hover:scale-115 hover:shadow-xl/50">Home</Link>
                  <Link to="/blog" class="p-1.5 bg-green-600 rounded-2xl shadow-xl/15 font-comicsans inset-shadow-sm inset-shadow-white/80 transition hover:scale-115 hover:shadow-xl/50">Blog</Link>
                  <Link to="/whoiam" class="p-1.5 bg-green-600 rounded-2xl shadow-xl/15 font-comicsans inset-shadow-sm inset-shadow-white/80 transition hover:scale-115 hover:shadow-xl/50">Who I am?</Link>
                  <Link to="/games" class="p-1.5 bg-green-600 rounded-2xl shadow-xl/15 font-comicsans inset-shadow-sm inset-shadow-white/80 transition hover:scale-115 hover:shadow-xl/50">Games I play</Link>
                </div>
      ...
      <div class="lg:block xs:hidden grid pb-2 justify-items-center">
        <div class="bg-green-800/1 rounded-b-2xl backdrop-blur-md backdrop-brightness-105 shadow-xl/50  ring-2 ring-inset ring-white/50 inset-shadow-sm inset-shadow-white/90 grid justify-center content-center">
          <div class="flex items-center justify-center p-2.5 relative">
            ...
            <header class="bg-green-800/70 bg-[radial-gradient(circle,rgba(255,255,255,0.2)_1px,transparent_1px)] bg-size-[6px_6px] rounded-2xl p-5 shadow-xl/50 ring-2 ring-inset ring-white/50 inset-shadow-sm inset-shadow-white/90 z-10">
              <Link to="/"><img src={Logo} class="items-center-safe transition hover:scale-115"></img></Link>
              <p class="text-center text-lg text-shadow-2xs text-shadow-black text-white font-comicsans">Welcome to my old internet website</p>
            </header>
          </div>
          <div class="grid p-3.5">
            <aside class="bg-green-700/40 bg-[radial-gradient(circle,rgba(255,255,255,0.2)_1px,transparent_1px)] bg-size-[6px_6px] backdrop-blur-md p-2 rounded-2xl shadow-xl/30 ring-2 ring-inset ring-white/50 inset-shadow-sm inset-shadow-white/90">
