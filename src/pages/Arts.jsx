              ...
              <div class="grid lg:grid-cols-3 gap-6 p-8 lg:min-w-400">
                {imgArt.map((art)=> (
                  <div class="grid justify-center">
                    <div class="group bg-linear-to-t to-green-800/60 from-blue-500/40 backdrop-blur-2xl inset-shadow-sm inset-shadow-white/40 p-3 rounded-2xl hover:scale-120 transition scale-90">
